...
# Text to display before the spinner (set before calling start)
BLA_loading_text=""
# Color for the spinner (set before calling start)
BLA_loading_color=""
BLA_reset_color='\033[0m'

BLA::play_loading_animation_loop() {
  while true ; do
    for frame in "${BLA_active_loading_animation[@]}" ; do
      printf "\r%b%b%s%b" "${BLA_loading_text}" "${BLA_loading_color}" "${frame}" "${BLA_reset_color}"
